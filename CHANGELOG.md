...
* Add retry to serial port opening [Ryan Cooke]

## 1.2.8 - 2026-02-23

* fix serial path variable [Ryan Cooke]
* add custom power routine for jetson-orin-nx-es [Ryan Cooke]
...
* lib/flashing/devices: Add Generic BIOS keyboard [Alexandru Costache]

## 1.2.5 - 2025-11-06

* update to node 20 [Ryan Cooke]

## 1.2.4 - 2025-07-14

* exit cleanly after flashing iot-gate devices [Ryan Cooke]
